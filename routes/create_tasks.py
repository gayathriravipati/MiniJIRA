...
# def get_next_task_id(user_id):
#     user_tasks = tasks_collection.find_one({"user_id": user_id})
#     if user_tasks and "tasks" in user_tasks:
#         max_task_id = max(task['task_id'] for task in user_tasks['tasks'])
